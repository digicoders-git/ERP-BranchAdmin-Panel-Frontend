...
import { FaMapMarkedAlt, FaPlus, FaGraduationCap, FaFileAlt, FaDollarSign, FaBullseye, FaTimes, FaTrash, FaExclamationTriangle } from 'react-icons/fa';
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl mb-8 border border-white/50 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              ...
              >
                <FaBullseye className="mr-2" /> Map Fee
              </button>
              <button 
                type="button" 
