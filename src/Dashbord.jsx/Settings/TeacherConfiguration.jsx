...
export default function TeacherConfiguration({ data, onSave, saving }) {
  const [formData, setFormData] = useState({
    idFormat: 'TCH-YYYY-0001',
    displayFields: ['name', 'email', 'phone', 'qualification', 'subject', 'experience'],
    customFields: [],
    idCardFields: ['name', 'id', 'photo', 'subject']
  });
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="border-t-2 pt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {['name', 'email', 'phone', 'qualification', 'subject', 'experience'].map(field => (
