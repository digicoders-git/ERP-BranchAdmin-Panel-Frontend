// StaffConfiguration.jsx
import React, { useState, useEffect } from 'react';
import { FaPlus, FaTrash } from 'react-icons/fa';

export default function StaffConfiguration({ data, onSave, saving }) {
  const [formData, setFormData] = useState({
    idFormat: 'ST-YYYY-0001',
    displayFields: ['name', 'email', 'phone', 'qualification', 'experience', 'salary'],
    customFields: [],
    idCardFields: ['name', 'id', 'photo', 'designation']
  });
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="border-t-2 pt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {['name', 'email', 'phone', 'qualification', 'experience', 'salary'].map(field => (
